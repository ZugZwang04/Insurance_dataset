...
-- To be entered in terminal; this is an encrypted backup
mysqldump -u root -p db_insurance | gzip | openssl enc -aes-256-cbc -out insurance_backup.sql.gz.enc -pass pass:MySecretKey123

-- To decrypt an encrypted backup
openssl enc -d -aes-256-cbc -in insurance_backup.sql.gz.enc -out insurance_backup.sql.gz -pass pass:MySecretKey123