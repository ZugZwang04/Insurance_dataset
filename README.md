Insurance Data ETL & MySQL Project

This project demonstrates the full ETL (Extract, Transform, Load) process using an insurance dataset. It highlights data cleaning, transformation, normalization, and database management skills.

Project Overview:
- Data Cleaning & Transformation: Inspected and cleaned the raw insurance dataset using Python Pandas, handling missing values, formatting inconsistencies, and converting columns to atomic values.
- Database Design & Normalization: Normalized the dataset into multiple related tables to eliminate redundancy and ensure data integrity.
